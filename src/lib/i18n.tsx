...
export const STRINGS = {
  en: {
    ...
    scale_up: 'Increase interface size',
    scale_down: 'Decrease interface size',
    nav_licence: 'Get your licence',
    nav_licence_short: 'Licence',
    nav_faq: 'FAQ',
    faq_title: 'Frequently asked questions',
    faq_eyebrow: 'Reference',
    faq_count: 'questions',
    faq_index: 'Questions',
    faq_expand: 'Expand all',
    faq_collapse: 'Collapse all',
    suggest_eyebrow: 'Submissions',
    s_how_title: 'How this works',
    s_how_1: 'Every submission is read by a person.',
    s_how_2: "Nothing reaches the map until it's verified.",
    s_how_3: 'No account needed, and nothing is tracked.',
    ...
    footer_short: 'No analytics, no tracking.',
    footer_more: 'How search works',
    footer_privacy:
  ...
  fr: {
    nav_map: 'Carte',
    scale_label: "Taille de l'interface",
    scale_up: "Agrandir l'interface",
    scale_down: "Réduire l'interface",
    nav_licence: 'Obtenir son permis',
    nav_licence_short: 'Permis',
    nav_faq: 'FAQ',
    faq_title: 'Foire aux questions',
    faq_eyebrow: 'Référence',
    faq_count: 'questions',
    faq_index: 'Questions',
    faq_expand: 'Tout afficher',
    faq_collapse: 'Tout réduire',
    suggest_eyebrow: 'Propositions',
    s_how_title: 'Comment ça fonctionne',
    s_how_1: 'Chaque proposition est lue par une personne.',
    s_how_2: "Rien n'apparaît sur la carte avant vérification.",
    s_how_3: 'Aucun compte requis, aucun suivi.',
    ...
    range_toggle: 'Champs de tir',
    stores_toggle: 'Magasins',
    ...
    density_legend_ranges: 'Champs de tir par 100 000 habitants',
    ranges_in_view: 'champs de tir visibles',
    density_popup_suffix: 'par 100 000 habitants',
    density_popup_suffix_ranges: 'par 100 000 habitants',
    ...
    footer_short: 'Aucune analyse, aucun suivi.',
    footer_more: "Comment fonctionne la recherche",
    footer_privacy:
