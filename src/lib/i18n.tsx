...
export const STRINGS = {
  en: {
    ...
    density_toggle: 'Density view (per capita)',
    density_legend: 'Stores per 100,000 residents',
    density_popup_suffix: 'per 100,000 residents',
    stores_in_view: 'stores in view',
    data_as_of: 'Data current as of',
    theme_title: 'Basemap',
    theme_light: 'Light',
    theme_dark: 'Dark',
    theme_white: 'White',
  ...
  fr: {
    ...
    density_toggle: 'Vue densité (par habitant)',
    density_legend: 'Magasins par 100 000 habitants',
    density_popup_suffix: 'par 100 000 habitants',
    stores_in_view: 'magasins visibles',
    data_as_of: 'Données à jour au',
